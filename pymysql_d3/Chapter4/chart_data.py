...
def get_quantity_data():
    # 取得所有產品的銷售數量資料
    quantity_query = """select  category,sub_category,count(sub_category)
    from Products
    group by category,sub_category;
